...
<header class="header header-editor">
  <div class="header-inner  header-inner-editor">
    <div class="header-sim">
      <p class="header-sim-button header-sim-model header-sim-model-pc checked" data-model="pc"></p>
      <p class="header-sim-button header-sim-model header-sim-model-sp" data-model="sp"></p>
      <div class="header-sim-setting active" data-model="pc">
      ...
      <div class="header-sim-setting" data-model="sp">
        <div class="header-sim-setting-inner">
          <p>
            <select class="header-sim-setting-input header-sim-setting-model">
