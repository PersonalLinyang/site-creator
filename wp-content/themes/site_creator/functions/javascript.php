  ...
  switch($key) {
    ...
    case 'common_editor':
      $translations = array(
        ...
        'layout_line'              => __('Line Layout', $lang_domain),
        'layout_row'              => __('Row Layout', $lang_domain),
...
function my_enqueue_scripts() {
  ...
  if(is_page() && get_field('editor_flag', $post->ID)) {
    ...
    $js_common_editor_block_path = 'assets/js/common/editor/block.js';
    wp_enqueue_script('js_common_editor_block', get_theme_file_uri($js_common_editor_block_path), 
        array('js_common_editor_common'), filemtime(get_theme_file_path($js_common_editor_block_path)));
    ...
    wp_enqueue_script('js_common_editor_index', get_theme_file_uri($js_common_editor_index_path), 
        array('js_common_editor_common'), filemtime(get_theme_file_path($js_common_editor_index_path)));
