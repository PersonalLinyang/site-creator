  ...
  switch($key) {
    ...
    case 'common_editor':
      $translations = array(
        ...
        'gradient_direction_ph'         => __('Gradient Direction Placeholder', $lang_domain),
        ...
        'gradient_custom_rotate'        => __('Custom Rotate', $lang_domain),
        'gradient_to_outside'           => __('To Outside', $lang_domain),
